...
function initThemeSelector() {
    ...
    // Theme button en footer
    if (themeBtnSm) {
        themeBtnSm.addEventListener('click', () => {
            // Alternar entre light y dark
            const currentTheme = body.className.includes('theme-dark') ? 'light' : 'dark';
...
// ========================================
// THEME SELECTOR SIMPLIFICADO (PARA HTML)
// ========================================
// Esta función se puede llamar directamente desde el HTML si prefieres
