...
<p><a href="/crm/leads/<?= (int)($lead['id'] ?? 0) ?>/followups">Ver followups del lead</a> · <a href="/crm/leads/<?= (int)($lead['id'] ?? 0) ?>/followup-task-dry-run">Simular tarea de seguimiento</a> · <a href="/crm/leads/<?= (int)($lead['id'] ?? 0) ?>/status">Actualizar status</a></p>
