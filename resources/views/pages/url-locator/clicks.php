...
<section class="eco-card">
  <h1>URL Locator — Clicks (read-only)</h1>
  <p><a class="eco-button btn" href="/url/locator/links">Ver short links</a></p>
  <p><strong>Privacidad:</strong> no se muestran IP, visitor_uuid, user_agent, referer ni clicked_url completos.</p>
  <?php if (!empty($errorMessage)): ?><p class="eco-alert error"><?= e((string)$errorMessage) ?></p><?php endif; ?>
  <p>Total clicks: <strong><?= e((string)($summary['total'] ?? 0)) ?></strong></p>
</section>
...
<section class="eco-card">
  ...
  <?php if (empty($clicks)): ?><p>Sin clicks registrados para este tenant.</p><?php else: ?>
