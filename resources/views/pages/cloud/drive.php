...
$capabilityMeta = [
    ...
    'controlled_download' => ['type' => 'controlled', 'route' => '/cloud/drive/files/{id}/download', 'permission' => 'cloud.view', 'note' => 'Bloqueada por flags por defecto.'],
    'upload_dry_run' => ['type' => 'dry-run', 'route' => '/cloud/drive/upload-dry-run', 'permission' => 'cloud.view', 'note' => 'Simulación de subida.'],
    'controlled_upload' => ['type' => 'controlled', 'route' => '/cloud/drive/upload', 'permission' => 'cloud.view', 'note' => 'Subida real controlada y bloqueada por defecto.'],
