...
final readonly class EcosistemaLandingSubmissionService
{
    ...
    private function maskText(string $value, int $visible): ?string { $t=trim($value); if($t==='') return null; return mb_substr($t, 0, $visible) . '***'; }
