...
- base principal histórica `ecosistema` (nombre unificado de diseño/historia);
- para operación actual de Core Admin, la base esperada se define por `DB_DATABASE` en `.env` (normalmente `adbbmis1_eco`);
- SQL unificado;
- documentación DBA;
- validaciones;
- health checks;
