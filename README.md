...
- Plan de observabilidad y monitoreo en entorno controlado (PR #257): [`docs/ops/CORE_ADMIN_OBSERVABILITY_MONITORING_PLAN.md`](docs/ops/CORE_ADMIN_OBSERVABILITY_MONITORING_PLAN.md)
