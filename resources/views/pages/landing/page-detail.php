...
<section class="eco-card">
  ...
  <?php else: ?>
    <p><a href="/landing/pages/<?= (int)$page['id'] ?>/visits">Ver visitas</a> | <a href="/landing/pages/<?= (int)$page['id'] ?>/forms">Ver formularios</a> | <a href="/landing/pages/<?= (int)$page['id'] ?>/submissions">Ver submissions</a></p>
