...
<p><a class="eco-button btn" href="/mail/messages/<?= e((string)($message['id'] ?? '0')) ?>/send-preview">Preview envío</a> <a class="eco-button btn" href="/mail/messages/<?= e((string)($message['id'] ?? '0')) ?>/attachments">Gestionar adjuntos</a></p>
<div class="eco-alert" role="status">Adjuntos lógicos habilitados. Envío binario de adjuntos sigue pendiente.</div>
