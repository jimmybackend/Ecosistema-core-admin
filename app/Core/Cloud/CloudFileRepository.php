...
final readonly class CloudFileRepository
{
    ...
    public function createUploaded(array $data): int
    {
        ...
        $stmt = $this->pdo->prepare('INSERT INTO cloud_files (tenant_id, user_id, bucket_id, original_name, stored_name, s3_key, mime_type, extension, size_bytes, checksum_sha256, origin_module, access_type, found_in_s3, virus_scan_status, status, uploaded_at, updated_at) VALUES (:tenant_id, :user_id, :bucket_id, :original_name, :stored_name, :s3_key, :mime_type, :extension, :size_bytes, :checksum_sha256, :origin_module, :access_type, :found_in_s3, :virus_scan_status, :status, NOW(), NOW())');
        $ok = $stmt->execute([
