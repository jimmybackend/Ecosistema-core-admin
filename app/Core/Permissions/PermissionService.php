...
public function changeStatus(int $id,string $status): string {$perm=$this->repository->findPermission($id); if($perm===null){return 'Permiso no encontrado.';} return 'La tabla core_permissions no tiene columna status; este cambio no está soportado por DB.';}
